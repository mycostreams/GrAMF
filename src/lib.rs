...
impl Scene {
    pub fn new(device: &wgpu::Device, surface_format: wgpu::TextureFormat) -> Self {
        let vertex_buffer = wgpu::util::DeviceExt::create_buffer_init(
            ...
            &wgpu::util::BufferInitDescriptor {
                ...
                contents: bytemuck::cast_slice(&constants::VERTICES),
        ...
        let index_buffer = wgpu::util::DeviceExt::create_buffer_init(
            ...
            &wgpu::util::BufferInitDescriptor {
                ...
                contents: bytemuck::cast_slice(&constants::INDICES),
    ...
    pub fn render<'rpass>(&'rpass self, renderpass: &mut wgpu::RenderPass<'rpass>) {
        ...
        renderpass.draw_indexed(0..(constants::INDICES.len() as _), 0, 0..1);
    }
    ...
    fn create_pipeline(
        ...
        let shader_module = device.create_shader_module(wgpu::ShaderModuleDescriptor {
            label: None,
            source: wgpu::ShaderSource::Wgsl(std::borrow::Cow::Borrowed(constants::SHADER_SOURCE)),
        });
